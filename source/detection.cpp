...
YoloDetection::YoloDetection(const std::string &modelPath,
...
void YoloDetection::getBestClassInfo(std::vector<float>::iterator it, const int &numClasses,
...
void YoloDetection::preprocessing(cv::Mat &image, float *&blob, std::vector<int64_t> &inputTensorShape)
{
...
std::vector<Detection> YoloDetection::postprocessing(const cv::Size &resizedImageShape,
...
std::vector<Detection> YoloDetection::detect(cv::Mat &image, const float &confThreshold = 0.4,
                                            const float &iouThreshold = 0.45)
{
    ...
    // std::cout << " inputNames[0] : " << inputNames.data()[0] << std::endl;
